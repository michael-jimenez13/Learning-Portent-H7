# Learning-Portenta-H7-And-Vision-Shield
Learning how to use this microcontroller . On this page it would include introductory stuff that includes testing functions of the microcontroller
